...
namespace HammaBob
{
	...
	public class HammaColour
	{
		public enum HammaSize
		{
			MINI,
			MIDI,
			BOTH
		...
		public HammaSize Size { get; set; }
		public HammaType Type { get; set; }
		...
		public event EnabledEventHandler EnabledEvent;
		...
		public HammaColour(Color colour)
		{
			this.Colour = colour;
		}

		public HammaColour(Color colour, HammaSize size, HammaType type, string name, int number)
		{
			this.Colour = colour;
			this.Size = size;
			this.Type = type;

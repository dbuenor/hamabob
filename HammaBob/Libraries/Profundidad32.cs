...
{
	public class Depth32Bits : BaseDepth
	{

		#region Constructor

		public Depth32Bits(Bitmap _bmpOriginal, byte[] _pixeles, byte[] _pixelesGen,
		...
		/// <param name="x"></param>
		/// <param name="y"></param>
		public override void ProcessImageBits(IEnumerable<HammaColour> coloresSeleccionados, int x, int y)
		{
			DrawImage((x * AnchoHamaGen) + (bmpDataGen.Stride * AltoHamaGen * y)
				, Color.FromArgb(
		...
		/// <param name="x"></param>
		/// <param name="y"></param>
		public override void ProcesarImagenBitsSOLOColor(IEnumerable<HammaColour> coloresSeleccionados, int x, int y)
		{
		...
		public override void DrawDigit(int numero, int posActual, int pixelesFila, DigitPosition digito)
		{
			int pixel;

			int posInicial = 0;

			if (digito == DigitPosition.Left)
				posInicial = 2 * stepGen;
			else if (digito == DigitPosition.Right)
		...
		public override void DrawHammaSquare(int posActual, int pixelesFila, int pixelInicio, Color color)
		{
			//Dibujo la linea superior de negro, es decir, pinto el borde
			DrawFullRowColour(posActual, colorBorde);
			...
			for (int i = 1; i < (AltoHamaGen); i++)
			{
				...
				DrawFullRowWithBorder(posActual, color, colorBorde);
			}
		}

		public override void DrawFullRowColour(int posicion, Color color)
		{
		...
		public override void DrawFullRowWithBorder(int posicion, Color color, Color colorBorde)
		{
			DrawPixel(posicion, colorBorde);
			posicion += step;
		...
		public override void DrawPixel(int posicion, Color color)
		{

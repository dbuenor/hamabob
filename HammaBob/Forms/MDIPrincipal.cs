...
namespace HammaBob.Formularios
{
	public partial class MDIPrincipal : Form
	{
		...
		List<HammaColour> listaColores = new List<HammaColour>();
		Size TamanioCuadradoGenerado = new Size(Constants.WidthGeneratedHamma, Constants.HeightGeneratedHamma);
		...
		{
			#region Colores
			listaColores.Add(new HammaColour(Color.FromArgb(255, 255, 255), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H01", 01));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 239, 189), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H02", 02));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 197, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H03", 03));
			listaColores.Add(new HammaColour(Color.FromArgb(228, 82, 20), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H04", 04));
			listaColores.Add(new HammaColour(Color.FromArgb(194, 43, 42), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H05", 05));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 142, 164), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H06", 06));
			listaColores.Add(new HammaColour(Color.FromArgb(105, 61, 159), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H07", 07));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 69, 132), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H08", 08));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 126, 190), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H09", 09));
			listaColores.Add(new HammaColour(Color.FromArgb(15, 138, 73), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H10", 10));
			listaColores.Add(new HammaColour(Color.FromArgb(92, 207, 151), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H11", 11));
			listaColores.Add(new HammaColour(Color.FromArgb(64, 36, 32), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H12", 12));
			listaColores.Add(new HammaColour(Color.FromArgb(224, 70, 76), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H13", 13));
			listaColores.Add(new HammaColour(Color.FromArgb(228, 192, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H14", 14));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 141, 201), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H15", 15));
			listaColores.Add(new HammaColour(Color.FromArgb(135, 221, 173), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H16", 16));
			listaColores.Add(new HammaColour(Color.FromArgb(142, 147, 151), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H17", 17));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 0, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H18", 18));
			listaColores.Add(new HammaColour(Color.FromArgb(229, 235, 244), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H19", 19));
			listaColores.Add(new HammaColour(Color.FromArgb(139, 57, 30), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H20", 20));
			listaColores.Add(new HammaColour(Color.FromArgb(192, 100, 46), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H21", 21));
			listaColores.Add(new HammaColour(Color.FromArgb(179, 27, 41), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H22", 22));
			listaColores.Add(new HammaColour(Color.FromArgb(118, 120, 121), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H23", 23));
			listaColores.Add(new HammaColour(Color.FromArgb(141, 109, 180), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H24", 24));
			listaColores.Add(new HammaColour(Color.FromArgb(157, 113, 78), HammaColour.HammaSize.BOTH, HammaColour.HammaType.TRANSLUCIDO, "H25", 25));
			listaColores.Add(new HammaColour(Color.FromArgb(237, 182, 159), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H26", 26));
			listaColores.Add(new HammaColour(Color.FromArgb(239, 190, 146), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H27", 27));
			listaColores.Add(new HammaColour(Color.FromArgb(24, 44, 29), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H28", 28));
			listaColores.Add(new HammaColour(Color.FromArgb(202, 17, 70), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H29", 29));
			listaColores.Add(new HammaColour(Color.FromArgb(90, 11, 21), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H30", 30));
			listaColores.Add(new HammaColour(Color.FromArgb(103, 169, 191), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H31", 31));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 0, 144), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H32", 32));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 66, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.FLUORESCENTE, "H33", 33));
			listaColores.Add(new HammaColour(Color.FromArgb(246, 255, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H34", 34));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 20, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H35", 35));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 22, 238), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H36", 36));
			listaColores.Add(new HammaColour(Color.FromArgb(121, 230, 51), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H37", 37));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 141, 49), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NEON, "H38", 38));
			listaColores.Add(new HammaColour(Color.FromArgb(242, 244, 95), HammaColour.HammaSize.BOTH, HammaColour.HammaType.FLUORESCENTE, "H39", 39));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 98, 36), HammaColour.HammaSize.BOTH, HammaColour.HammaType.FLUORESCENTE, "H40", 40));
			listaColores.Add(new HammaColour(Color.FromArgb(0, 93, 163), HammaColour.HammaSize.BOTH, HammaColour.HammaType.FLUORESCENTE, "H41", 41));
			listaColores.Add(new HammaColour(Color.FromArgb(87, 190, 0), HammaColour.HammaSize.BOTH, HammaColour.HammaType.FLUORESCENTE, "H42", 42));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 253, 112), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H43", 43));
			listaColores.Add(new HammaColour(Color.FromArgb(255, 118, 117), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H44", 44));
			listaColores.Add(new HammaColour(Color.FromArgb(168, 134, 195), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H45", 45));
			listaColores.Add(new HammaColour(Color.FromArgb(139, 199, 235), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H46", 46));
			listaColores.Add(new HammaColour(Color.FromArgb(188, 242, 94), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H47", 47));
			listaColores.Add(new HammaColour(Color.FromArgb(233, 145, 201), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H48", 48));
			listaColores.Add(new HammaColour(Color.FromArgb(90, 189, 206), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H49", 49));
			listaColores.Add(new HammaColour(Color.FromArgb(230, 240, 214), HammaColour.HammaSize.MIDI, HammaColour.HammaType.FOSFORESCENTE, "H55", 55));
			listaColores.Add(new HammaColour(Color.FromArgb(243, 218, 214), HammaColour.HammaSize.MIDI, HammaColour.HammaType.FOSFORESCENTE, "H56", 56));
			listaColores.Add(new HammaColour(Color.FromArgb(212, 215, 217), HammaColour.HammaSize.MIDI, HammaColour.HammaType.FOSFORESCENTE, "H57", 57));
			listaColores.Add(new HammaColour(Color.FromArgb(241, 161, 37), HammaColour.HammaSize.MIDI, HammaColour.HammaType.NORMAL, "H60", 60));
			listaColores.Add(new HammaColour(Color.FromArgb(234, 183, 50), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H61", 61));
			listaColores.Add(new HammaColour(Color.FromArgb(161, 158, 158), HammaColour.HammaSize.MIDI, HammaColour.HammaType.NORMAL, "H62", 62));
			listaColores.Add(new HammaColour(Color.FromArgb(143, 114, 36), HammaColour.HammaSize.MIDI, HammaColour.HammaType.NORMAL, "H63", 63));
			listaColores.Add(new HammaColour(Color.FromArgb(231, 222, 218), HammaColour.HammaSize.MIDI, HammaColour.HammaType.NORMAL, "H64", 64));
			listaColores.Add(new HammaColour(Color.FromArgb(205, 207, 213), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H70", 70));
			listaColores.Add(new HammaColour(Color.FromArgb(48, 54, 60), HammaColour.HammaSize.BOTH, HammaColour.HammaType.NORMAL, "H71", 71));
			#endregion
		}
		...
		{
			cmbTipoMedida.ComboBox.DataSource = Enum.GetNames(typeof(MeasureType));
		...
		private void Inicializar_Controles_Colores()
		{
			...
			foreach (HammaColour.HammaType _tipo in Enum.GetValues(typeof(HammaColour.HammaType)))
			{
				...
				List<HammaColour> ColoresTipo = listaColores.Where(x => x.Type == _tipo).ToList();
				int columna = 0;
				int numColumnas = 2;
				...
				foreach (HammaColour _color in ColoresTipo)
				{
					if (columna == 0)
					...
					{
						NombreColor = _color.Name,
						Name = "chk" + _color.Name,
						//Size = new Size(100, 22),
						Color = _color
					};

					chkColor.Chk.Checked = _color.Enabled;
		...
		{
			foreach (HammaColour color in listaColores.Where(x => x.PiecesCount > 0))
				color.PiecesCount = 0;
		}
		...
		private void ActualizarEtiquetasConNumeroDePiezasHama()
		{
			foreach (HammaColour color in listaColores.Where(x => x.PiecesCount > 0))
			{
				try
				{
					colorCheckBox chk = (colorCheckBox)tbColores.Controls.Find("chk" + color.Name, true)[0];
					chk.NumPiezas = color.PiecesCount;
		...
		private void ActualizarEstadisticas()
		{
			...
			HammaColour aux = null;

			do
			{
				aux = listaColores
					.Where(x => x.PiecesCount.Equals
						(listaColores
						.Where(y => y.PiecesCount < numPiezas)
						.Max(y => y.PiecesCount)
						))
						.First();

				numPiezas = aux.PiecesCount;

				gbEstadisticas.Controls.Add(new Label() { Text = aux.Name + "- " + aux.PiecesCount });
			}
			while (numPiezas > 0);
		}
		...
		private void chkTipo_CheckedChanged(object sender, EventArgs e)
		{
			...
			HammaColour.HammaType tipo = (HammaColour.HammaType)Convert.ToInt16(chkTipo.Tag);
		...
		private void AbrirImagen()
		{
			...
			if (resultado == System.Windows.Forms.DialogResult.OK)
			{
				...
				Cargar_Imagen(openFileDialog.FileNames[0], Ancho.Pixels, Alto.Pixels);
		...
		private void Procesar_Imagen()
		{
			try
			{
				...
				{
					throw new CustomException("Error al crear la imagen generada. Se ha excedido el tamaño maximo. (Tamaño Actual: "
						+ (bmpOriginal.Width * Constants.WidthGeneratedHamma).ToString() + "x"
						+ (bmpOriginal.Height * Constants.HeightGeneratedHamma).ToString() + ").", ex);
				}
				...
				List<HammaColour> coloresSeleccionados = listaColores.Where(x => x.Enabled).ToList();
				BaseDepth procesador = null;

				switch (bmpOriginal.PixelFormat)
				{
					case PixelFormat.Format24bppRgb:
						procesador = new Depth24Bits(bmpOriginal, Pixeles, PixelesGen, bmpData, bmpDataGen, step, stepGen);
						break;
					case PixelFormat.Format32bppArgb:
						procesador = new Depth32Bits(bmpOriginal, Pixeles, PixelesGen, bmpData, bmpDataGen, step, stepGen);
						break;
				}

				procesador.barraProgreso = this.barraProgreso;
				procesador.StepDoneEvent += new BaseDepth.StepDoneHandler(procesador_StepDone);

				this.Cursor = Cursors.WaitCursor;

				procesador.ProcessImage(coloresSeleccionados, false);
		...
		void procesador_StepDone()
		{
			if (barraProgreso.InvokeRequired)
			{
				...
				barraProgreso.BeginInvoke((BaseDepth.StepDoneHandler)delegate
				{
					barraProgreso.PerformStep();
				});
			}
		...
		private void Guardar_Configuracion_Hamas(XmlDocument doc, XmlElement elementoPrincipal)
		{
			...
			if (rdbMisHamas.Checked)
			{
				...
				if (el == null)
				{
					...
					foreach (HammaColour color in listaColores)
					{
						XmlElement elColor = (XmlElement)el.AppendChild(doc.CreateElement(color.Colour.Name));
						elColor.SetAttribute("Nombre", color.Name);
						elColor.SetAttribute("RGB", color.Colour.ToArgb().ToString());
						elColor.SetAttribute("Habilitado", color.Enabled.ToString());
					}
				}
				else
				{
					foreach (HammaColour color in listaColores)
					{
						XmlElement elColor = (XmlElement)el.GetElementsByTagName(color.Colour.Name)[0];
						elColor.SetAttribute("Habilitado", color.Enabled.ToString());
					}
				}
			}
		...
		private void Cargar_Configuracion_Hamas()
		{
			if (System.IO.File.Exists(rutaConfig))
			{
				...
				if (el != null)
				{
					foreach (HammaColour color in listaColores)
					{
						XmlElement nodo = (XmlElement)el.GetElementsByTagName(color.Colour.Name)[0];
						color.Enabled = Convert.ToBoolean(nodo.GetAttribute("Habilitado"));
					}
				}
			}
		}
		...
		private void Trocear_Imagen_Entera()
		{
			...
			if (!string.IsNullOrEmpty(rutaGuardado))
			{
				...
				barraProgreso.Step = 1;
				barraProgreso.Value = 0;
				barraProgreso.Maximum = (int)Math.Round((double)bmpGenerado.Height / Constants.HeightSheetPixels);

				for (int y = 0; y <= bmpOriginal.Height; y += Constants.HeightSheetPixels)
				{
					for (int x = 0; x <= bmpOriginal.Width; x += Constants.WidthSheetPixels)
					{
						...
						path.AddString(Texto, fuente.FontFamily
							, (int)FontStyle.Bold, TamanioFuente, new Point((x + Constants.WidthSheetPixels / 4), (y + Constants.HeightSheetPixels / 4)),
		...
		{
			Bitmap bmpAux = new Bitmap(Constants.WidthSheetPixels, Constants.HeightSheetPixels, bmpGenerado.PixelFormat);
			...
			try
			{
				try
				{
					Graphics.FromImage(bmpAux).DrawImage(bmpGenerado, new Rectangle(0, 0, Constants.WidthSheetPixels, Constants.HeightSheetPixels),
						new Rectangle(x, y, Constants.WidthSheetPixels, Constants.HeightSheetPixels), GraphicsUnit.Pixel);
					bmpTroceada = new Bitmap(bmpAux.Width * Constants.WidthGeneratedHamma, bmpAux.Height * Constants.HeightGeneratedHamma, bmpAux.PixelFormat);
				}
				catch (System.Exception ex)
				{
					throw new CustomException("Error al crear la imagen generada. Se ha excedido el tamaño maximo. (Tamaño Actual: "
						+ (bmpGenerado.Width * Constants.WidthGeneratedHamma).ToString() + "x"
						+ (bmpGenerado.Height * Constants.HeightGeneratedHamma).ToString() + ").", ex);
				}
				...
				List<HammaColour> coloresSeleccionados = listaColores.Where(i => i.Enabled).ToList();
				BaseDepth procesador = null;

				switch (bmpAux.PixelFormat)
				{
					case PixelFormat.Format24bppRgb:
						procesador = new Depth24Bits(bmpAux, PixelesAux, PixelesTroceada, bmpDataAux, bmpDataTroceada, stepAux, stepTroceada);
						break;
					case PixelFormat.Format32bppArgb:
						procesador = new Depth32Bits(bmpAux, PixelesAux, PixelesTroceada, bmpDataAux, bmpDataTroceada, stepAux, stepTroceada);
						break;
				}

				this.Cursor = Cursors.WaitCursor;

				procesador.ProcessImage(coloresSeleccionados, true);
		...
		{
			this.pbZoomOriginal.TipoMedida = (MeasureType)cmbTipoMedida.SelectedIndex;
			this.pbZoomGenerada.TipoMedida = (MeasureType)cmbTipoMedida.SelectedIndex;
		}
	}
}
